...
class Panels:
    ...
    def draw_exit1(self, img: cv2.typing.MatLike, img_exit: cv2.typing.MatLike, pos_x, pos_y, restart_def, resume_def, now, text) -> cv2.typing.MatLike:
        ...
        bt_x1, bt_x2, bt_x3, bt_x4 = menu_x + menu_w*(2/10), menu_x + menu_w*(4.5/10), menu_x + menu_w*(6/10), menu_x + menu_w*(8.5/10)
        cvzone.overlayPNG(img, img_exit, (menu_x, menu_y))
        cv2.putText(img, text, (menu_x + 20, menu_y + 50), cv2.FONT_HERSHEY_SCRIPT_COMPLEX, 1, (255, 255, 255), 1)
    ...
    def draw_exit(self, img: cv2.typing.MatLike, img_exit: cv2.typing.MatLike, pos_x, pos_y, restart_def, resume_def, now, text) -> cv2.typing.MatLike:
        ...
        # Pillow ile metin ekleme
        pil_image = Image.fromarray(img)
        draw = ImageDraw.Draw(pil_image)
        font = ImageFont.truetype("arial.ttf", 32)  # Arial yazı tipini kullanın
        draw.text((menu_x + 20, menu_y + 50), text, font=font, fill=(0, 0, 0))
